    ...
    const verificarCSS = () => {
        ...
        if (!reglas) {
            setMensaje(
                <div className="flex items-center justify-center gap-2 text-red-600 font-semibold">
                    ...
                    <span>
                        Usa el selector <code>section &gt; p</code> con las propiedades <code>color: red;</code> y <code>font-weight: bold;</code>
                    </span>
                </div>
            );
            return;
        ...
        if (normalizadas.length !== 2 || !todasCorrectas) {
            setMensaje(
                <div className="flex items-center justify-center gap-2 text-red-600 font-semibold">
                    <XCircle className="w-5 h-5" />
                    <span>Debes incluir exactamente <code>color: red;</code> y <code>font-weight: bold;</code></span>
                </div>
            );
            return;
        }
