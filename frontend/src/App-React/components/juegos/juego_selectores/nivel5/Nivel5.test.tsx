...
describe('Nivel5', () => {
    ...
    const renderComponent = () => render(<Nivel5 />);
    ...
    it('renderiza correctamente los elementos clave', () => {
        ...
        const titulo = screen.getByRole('heading', { name: /nivel 5 - css detective/i });
    ...
    it('valida CSS correcto, muestra mensaje de éxito y guarda en sessionStorage', async () => {
        ...
        await waitFor(() => {
            ...
            expect(sessionStorage.getItem('nivel5Superado')).toBe('true');
        });
    });
});
