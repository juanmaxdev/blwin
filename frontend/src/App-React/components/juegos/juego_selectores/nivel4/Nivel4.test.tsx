...
describe('Nivel4', () => {
    ...
    const renderComponent = () => render(<Nivel4 />);
    ...
    it('renderiza correctamente los elementos clave', () => {
        ...
        const titulo = screen.getByRole('heading', { name: /nivel 4 - css detective/i });
    ...
    it('valida CSS correcto, muestra mensaje de éxito y guarda en sessionStorage', async () => {
        ...
        await waitFor(() => {
            ...
            expect(sessionStorage.getItem('nivel4Superado')).toBe('true');
        });
    });
});
