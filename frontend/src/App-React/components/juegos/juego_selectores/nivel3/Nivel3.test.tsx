...
describe('Nivel3', () => {
    ...
    const renderComponent = () => render(<Nivel3 />);
    ...
    it('renderiza correctamente los elementos clave', () => {
        ...
        const titulo = screen.getByRole('heading', { name: /nivel 3 - css detective/i });
    ...
    it('valida CSS correcto, muestra mensaje de éxito y guarda en sessionStorage', async () => {
        ...
        await waitFor(() => {
            ...
            expect(sessionStorage.getItem('nivel3Superado')).toBe('true');
        });
    });
});
