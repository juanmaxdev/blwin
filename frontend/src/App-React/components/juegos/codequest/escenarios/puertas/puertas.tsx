...
export default function Puertas({
 ...
 return (
    <div className="flex flex-col items-center justify-center h-full px-2 sm:px-4">
      <h2 className="textoTales text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-violet-100 mb-4 sm:mb-6 md:mb-8 text-center drop-shadow-lg">
        Elige una puerta para enfrentar tu desafío
      </h2>

      <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 md:gap-8 mb-4 sm:mb-6 md:mb-8">
        {/* Puerta Fácil */}
        <motion.div
      ...
      <div className="bg-white bg-opacity-80 p-3 sm:p-4 md:p-6 rounded-xl max-w-xs sm:max-w-lg md:max-w-2xl">
